...
<template>
	<div class="autocomplete" :class="{ 'isOpen': isOpen }">
		<input ref="mopInput" type="text" :id="`mop-input-${transactionIndex}`" @input="onChange" @focus="onChange"
			v-model="search" @keydown.down="onArrowDown" @keydown.up="onArrowUp" @keydown.enter="onEnter"
			class="form-control mopcls"
		/>
